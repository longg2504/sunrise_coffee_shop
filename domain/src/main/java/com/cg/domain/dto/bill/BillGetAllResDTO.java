...
public class BillGetAllResDTO {
    ...
    public BillGetAllResDTO(Long id, Date createdAt, BigDecimal orderPrice, BigDecimal discountMoney, Long discountPercent, BigDecimal chargeMoney, Long chargePercent, BigDecimal totalAmount, Long tableId, String tableName, Long orderId, Long staffId, String staffName, Boolean paid) {
        this.id = id;
